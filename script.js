document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.resume-accordion .accordion-header').forEach(header => {
        header.addEventListener('click', function() {
            const item = this.parentElement;
            const allItems = document.querySelectorAll('.resume-accordion .accordion-item');
...
function initTerminal() {
    ...
    const commands = [
      { cmd: 'whoami', output: 'Faizan Anwar - DevOps Engineer & SRE' },
      { cmd: 'skills --list', output: 'AWS, Azure, GCP, Kubernetes, Terraform, CI/CD' },
      { cmd: 'contact --email', output: 'faizananwar532@gmail.com' },
...
function initProjectCardOverlays() {
  document.querySelectorAll('.project-card').forEach(card => {
    ...
    const iconMap = {
      AWS: 'fab fa-aws', Azure: 'fab fa-microsoft', GCP: 'fab fa-google',
      Terraform: 'fas fa-code', Kubernetes: 'fas fa-dharmachakra', Docker: 'fab fa-docker',
      Prometheus: 'fas fa-fire', Grafana: 'fas fa-chart-bar', ELK: 'fas fa-chart-line',
      Argo: 'fas fa-code-branch', Vault: 'fas fa-vault', Airflow: 'fas fa-wind',
      Jenkins: 'fab fa-jenkins', GitLab: 'fab fa-gitlab', GitHub: 'fab fa-github',
      Ansible: 'fas fa-cogs', Helm3: 'fas fa-ship', AKS: 'fab fa-microsoft', EKS: 'fab fa-aws', GKE: 'fab fa-google',
      'GitLab CI': 'fab fa-gitlab', 'GitHub Actions': 'fab fa-github',
      Open: 'fas fa-code', DevOps: 'fas fa-server', Infrastructure: 'fas fa-network-wired', Automation: 'fas fa-robot'
    };
